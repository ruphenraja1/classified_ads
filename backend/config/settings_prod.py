...
Production settings should be run with:
  DJANGO_ENV=prod
...
This file expects the following environment variables:
  ...
  - POSTGRES_USER
  - POSTGRES_PASSWORD
  - POSTGRES_HOST (usually the service name in docker-compose, e.g., 'db')
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 20,
    # Add this exact block below to bypass Session CSRF checks on the API:
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.BasicAuthentication',
        # (Notice we dynamically leave 'SessionAuthentication' completely out!)
    ],
}
